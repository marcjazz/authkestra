...
#[proc_macro_derive(AuthkestraRepository, attributes(authkestra))]
pub fn derive_authkestra_repository(input: TokenStream) -> TokenStream {
    derive::derive_authkestra_repository_impl(input)
}
