...
```rust
use authly_session::{MemoryStore, SessionStore};
...
```rust
use authly_session::RedisStore;

// redis_url, prefix
let store = RedisStore::new("redis://127.0.0.1/", "authly_session".to_string())?;
```
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Uses default table name "authly_sessions"
